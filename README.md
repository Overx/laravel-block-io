...
composer require overx/laravel-block-io
...
return [
    ...
    'providers' => [
         ...
         */
        Overx\LaravelBlockIo\LaraBlockIoServiceProvider::class, // [a]
    ...
    'aliases' => [
        ...
        'LaraBlockIo' => 'Overx\LaravelBlockIo\LaraBlockIoFacade', // [b]
